...
class TestViewModel : ViewModel() {
    ...
    val gson = Gson()
    var contactList = gson.fromJson(json, Array<Contact>::class.java).asList().toMutableStateList()


    fun update(contactId : String, firstName : String, lastName : String, email : String, phone : String) {

        contactList.find{ it.id == contactId }?.firstName = firstName
        contactList.find{ it.id == contactId }?.lastName = lastName
        contactList.find{ it.id == contactId }?.email = email
        contactList.find{ it.id == contactId }?.phone = phone
    }
    ...
    fun isContactValid( firstName : String, lastName : String) : Boolean{
